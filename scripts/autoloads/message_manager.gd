...
var message_data: Dictionary[String, String] = {
    ...
    "all_lamps_lit": "Ah, now it’s properly bright! If only I could warm up… my teeth are chattering",
    "firewood_not_found": "Too high… I cannot reach there. I'm a gnome, after all",
    "firewood_found": "Firewood is here, matches are here… and the hearth as well. What a fine day!",
    ...
    "fireplace_lit": "Ah, how warm and cozy now… almost like home!",
    "xylophone_start": "What a delightful sound!",
    "xylophone_5th": "All of this must surely mean something…",
    "xylophone_10th": "Perhaps I should try to play a melody…?",
    "xylophone_15th": "Better listen carefully…",
    "xylophone_20th": "1… 3… 2… 3… 4… Why did that suddenly cross my mind?",
}
